...
name_dataset='Gowalla'; methods={'LapT','NorT','CirT','Exp','BA'};
% name_dataset='Brightkite'; methods={'LapT','NorT','CirT','Exp','BA'};
...
for k=1:length(methods)
    ...
    load(sprintf('RESULTS/RES_SFQWC_%s_%s.mat',method,name_dataset),'QminL2_measures','QnoR_measures',...
            'PAEl2_measures','PAEMSE_measures','PAEH_measures','PCE_measures');
        
    if ismember(method,{'CirT','LapT','NorT'})
